class Section < ActiveRecord::Base
	#ENTIDAD SECTION
	#Esta entidad fue creada para la clasificación de los diferentes publicaciones que pueden realizar los
	#administradores del sitio, las cuales se desplegarán de manera ordenada en el sitio web.

	#ATRIBUTOS
	#title: Título de la publicación.
	#module: módulo o clasificación de las publicaciones que representan las secciones.
	...
	#priority: Prioridad de la publicación para dar un orden de estas.
	...
	#Función que permite que el buscador encuentre Secciones a través de match de palabras en sus atributos.
